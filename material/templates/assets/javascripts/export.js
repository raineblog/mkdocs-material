function add_giscus() {
    ...
    giscusScript.setAttribute("data-repo", "{{ giscus.data_repo }}");
    giscusScript.setAttribute("data-repo-id", "{{ giscus.data_repo_id }}");
    giscusScript.setAttribute("data-category", "Announcements");
    giscusScript.setAttribute("data-category-id", "{{ giscus.data_category_id }}");
